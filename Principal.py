...
class MeuApp(QMainWindow):
    def __init__(self):
        ...
        # self.ui.CombB_Tipo_Filtro.currentTextChanged.connect(self.f.Alterar_valor_Filtro)
        self.ui.SB_Parametro_Filtro.valueChanged.connect(lambda: self.f.Atualizar_Grafico("Curvas", self.ui.CombB_Selecionar_Curva.currentText(), "Filtro", self.ui.SB_Parametro_Filtro.value()))
        self.ui.CB_Ativar_Filtro.stateChanged.connect(lambda: self.f.Atualizar_Grafico("Curvas", self.ui.CombB_Selecionar_Curva.currentText(), "Filtro", self.ui.SB_Parametro_Filtro.value()))
